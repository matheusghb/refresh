...
EJN: Eu g)ost)o de c)onversar de f)orma mais <- Esp)orática++ ->, usand)o símb)ol)os da alquimia para expressar cert)os sentiment)os. Ainda assim, mantenho a seriedade em m)oment)os de necessidade. -*
	o = )o (simbolo do cobalto)
	ênfase = <- texto -> (<>- sendo o simbolo do sal)
	final de frase = -\*, podendo modificar a quantidade de \*s. Representa apresso.
	w = )u( (simbolo da lua)
	! = + (simbolo do vinagre)
...
EDS: Sou \* um \* pouco \* frouxo \* e \* recluso \* mas \* não \* deixo \* isso \* me \* abalar.
